...
- (void)sendEventWithId:(NSString * _Nonnull)id body:(NSDictionary<NSString *, id> * _Nullable)body;
- (void)sendEventWithId:(NSString * _Nonnull)id body:(NSDictionary<NSString *, id> * _Nullable)body callback:(void (^ _Nonnull)(BOOL, NSString * _Nonnull))callback;
...
- (void)setAttributeWithKey:(NSString * _Nonnull)key value:(id _Nonnull)value callback:(void (^ _Nonnull)(BOOL, NSString * _Nonnull))callback;
